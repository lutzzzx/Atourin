...
@section('title') Tambah Destinasi @endsection
...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="destinasi-form" action="{{ route('details.store', $agenda) }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                ...
                                />
                                <label for="floatingemailInput">Biaya</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input
                                    ...
                                    name="selesai"
                                    placeholder="Enter Waktu Selesai"
                                />
                    ...
                    <div>
                        <button type="submit" id="submit-button" class="btn btn-primary w-md" data-single-click>Simpan</button>
                    </div>
                </form>
            </div>
            <!-- end card body -->
